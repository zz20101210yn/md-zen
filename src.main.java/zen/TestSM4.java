...
public class TestSM4 {
	public static void main(String[] args) {
        // 明文数据
        String plainText = "13726584806DEL";//13122650058
...
//        // ================= 加密 =================
        String encryptedHex = sm4.encryptHex(plainText);
        System.out.println("加密结果(16进制): " + encryptedHex);
        
        
        List<String> list = new ArrayList<String>();
        list.add("4c0b0608756aed7d725f95eadbf17153");
        
        for(String str: list) {
        	String decryptedText = sm4.decryptStr(str);
...
//        StringBuilder st = new StringBuilder("INSERT INTO `<table_name>` (`source`, `order_sn`, `product_name`, `order_time`, `returned_date`, `returned_money`, `order_status`, `product_unit_price`, `amount`, `total_price`, `status`, `create_time`, `create_by`, `create_by_id`, `del_flag`, `payer`, `phone`) VALUES ('启明星', '545606071545368576', '资金为王体验版', '2022-02-14 14:03:44', '2022-02-14 14:03:44', 0.00, '已支付', 0.00, 1, 0.00, 1, '2025/09/03 00:00:00', 'sync', 2155, 0, '用户1zz2', '^13916399540~');");
